...
export class RxCoreService {
  ...
  private _guiPDFLayers: BehaviorSubject<Array<IPDFLayer>> = new BehaviorSubject<Array<IPDFLayer>>([]);
  guiPDFLayers$: Observable<Array<IPDFLayer>> = this._guiPDFLayers.asObservable();
  public setGuiPDFLayers(list: Array<IPDFLayer>): void {
    this._guiPDFLayers.next(list);
  }
  public getGuiPDFLayers(): Array<IPDFLayer> {
    return this._guiPDFLayers.getValue();
  }
